...
mafft \
	...
	--thread 9 \ #use 9 threads to run faster
	 --keeplength \
	 --addfragments \
	 /vortexfs1/omics/env-bio/collaboration/env_bio_covid/data/hcov_north-america/hcov_north-america.fasta \ #sequences to align 
	...
	> /vortexfs1/omics/env-bio/collaboration/env_bio_covid/data/mafft_iqtree_out/aligned_mafft_ncov_north-america.fasta \ #final alignment in fasta form
	2> /vortexfs1/omics/env-bio/collaboration/env_bio_covid/code/logs_mafft/align_mafft_ncov-north-america.txt #txt log output
