...
mafft \
	...
	--thread 9 \ #use 9 threads to run faster
	 /vortexfs1/omics/env-bio/collaboration/env_bio_covid/data/b.1.526/b1526.sequences.fasta \ #sequences to align 
	...
	> /vortexfs1/omics/env-bio/collaboration/env_bio_covid/data/mafft_iqtree_out/aligned_mafft_ncov_b1526.fasta \ #final alignment in fasta form
	2> /vortexfs1/omics/env-bio/collaboration/env_bio_covid/code/logs_mafft/align_mafft_ncov_b1526.txt #txt log output
